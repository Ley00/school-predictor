...
2. a extração dos CSVs e a geração de dados sintéticos compatíveis com o contrato público
...
def prepare_private_database(user: str = "Warley", source_database: str | None = None) -> str:
    raise NotImplementedError(
        "Implemente aqui a rotina local de preparação dos insumos e geração dos dados sintéticos usados pela versão pública."
    )
