...
A Tabela~\ref{tab:exemplo-alerta} apresenta um caso demonstrativo retirado dos artefatos de teste com dados falsos gerados. O exemplo \'e \'util porque mostra por que o projeto manteve um classificador de risco, e n\~ao apenas uma regra baseada na nota prevista.
