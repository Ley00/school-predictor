...
No modo \texttt{alerta\_risco}, o melhor cen\'ario foi obtido com hist\'orico m\'inimo igual a 2. Nessa configura\c{c}\~ao, a base de modelagem alcan\c{c}ou 50.065 linhas, 1.179 alunos \'unicos e 53 disciplinas. O melhor classificador foi o \textit{HistGradientBoostingClassifier}, com os resultados apresentados na Tabela~\ref{tab:riscos}. Em compara\c{c}\~ao com o modo de previs\~ao de nota, a base fica menor, mas o sinal hist\'orico torna-se mais consistente para uma tarefa de alerta.
...
Tamb\'em foram constru\'idos consolidados por professor, com e sem recorte por turma, al\'em do ranking executivo da coordena\c{c}\~ao. Essa camada aproxima a modelagem do cotidiano escolar, pois transforma predi\c{c}\~ao, sinal de risco, pontua\c{c}\~ao e prioridade de interven\c{c}\~ao em informa\c{c}\~ao compreens\'ivel por cada perfil de uso. Em termos de contribui\c{c}\~ao do TCC, esse ponto \'e relevante porque desloca a discuss\~ao de ``qual modelo venceu'' para ``como a sa\'ida se torna utiliz\'avel''.

\section{An\'alise de erro e calibra\c{c}\~ao}
\label{sec:erro}

A an\'alise de erro mostrou maior dificuldade de previs\~ao em disciplinas como Matem\'atica 3, Matem\'atica 4 e 5, Biologia 2, Hist\'oria 2 e Qu\'imica 3. Tamb\'em houve maior erro nas faixas de nota abaixo de 7, especialmente porque esses casos s\~ao mais inst\'aveis e pedagogicamente mais sens\'iveis. Essa leitura \'e importante porque os pontos de maior erro coincidem justamente com zonas em que a escola tende a demandar mais aten\c{c}\~ao.
...
Com essa calibra\c{c}\~ao, a prioriza\c{c}\~ao ficou mais compat\'ivel com o uso institucional, reduzindo sobrecarga sobre coordena\c{c}\~ao e professores. Assim, a sa\'ida final do sistema n\~ao deve ser lida como senten\c{c}a sobre o aluno, mas como convite estruturado \`a investiga\c{c}\~ao pedag\'ogica. Esse fechamento sintetiza a posi\c{c}\~ao adotada ao longo de todo o trabalho: a modelagem s\'o faz sentido quando seus resultados podem ser interpretados, filtrados e usados com prud\^encia.
