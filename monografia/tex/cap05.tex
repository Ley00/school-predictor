...
Tamb\'em foram constru\'idos consolidados por professor, com e sem recorte por turma, al\'em do ranking executivo da coordena\c{c}\~ao. Essa camada aproxima a modelagem do cotidiano escolar, pois transforma predi\c{c}\~ao, sinal de risco, pontua\c{c}\~ao e prioridade de interven\c{c}\~ao em informa\c{c}\~ao compreens\'ivel por cada perfil de uso.
