...
Considerando o foco deste trabalho em prever a pr\'oxima nota e sinalizar risco pedag\'ogico, a literatura mais pr\'oxima pode ser organizada em dois subconjuntos: estudos voltados \`a previs\~ao de nota futura e estudos voltados \`a detec\c{c}\~ao de alunos em risco acad\^emico. A Tabela~\ref{tab:trab-rel-prev-nota} resume dois estudos representativos do primeiro grupo, de Morsy e Karypis \cite{morsy2017} e de Widjaja et al. \cite{widjaja2020}. Eles ajudam a situar o problema da regress\~ao da pr\'oxima nota dentro de uma linha de pesquisa j\'a consolidada, embora majoritariamente concentrada em ensino superior.
...
A Tabela~\ref{tab:trab-rel-risco} resume dois trabalhos representativos do eixo de detec\c{c}\~ao de risco, de Lakkaraju et al. \cite{lakkaraju2015} e de Koprinska, Stretton e Yacef \cite{koprinska2015}. Nesse grupo, a proximidade com esta pesquisa aparece menos no tipo exato de alvo e mais na preocupa\c{c}\~ao com identifica\c{c}\~ao precoce e utilidade institucional.
