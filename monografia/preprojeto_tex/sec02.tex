...
O texto do \sigla{TCC}{Trabalho de Conclus\~ao de Curso} seria dividido em se\c{c}\~oes principais, incluindo revis\~ao da literatura sobre redes neurais de grafos e reconhecimento de padr\~oes em dados educacionais, descri\c{c}\~ao detalhada da metodologia, apresenta\c{c}\~ao dos resultados obtidos com conjuntos de dados falsos gerados e discuss\~ao das implica\c{c}\~oes pr\'aticas desses resultados. Tamb\'em se previu a an\'alise de limita\c{c}\~oes, desafios e dire\c{c}\~oes futuras de pesquisa.
